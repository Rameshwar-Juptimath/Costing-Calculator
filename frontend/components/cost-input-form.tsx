                    ...
                    <tr key={step.id} className="hover:bg-slate-50 transition-colors" data-testid="routing-step-row">
                      ...
                      <td className="py-2 px-2 text-right">
                        <input
                          ...
                          className="w-16 h-6 px-1 text-right font-mono text-xs border border-slate-200 rounded focus:border-indigo-600 outline-none bg-slate-50 focus:bg-white font-semibold text-slate-900"
                          placeholder="0"
